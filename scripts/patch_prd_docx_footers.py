#!/usr/bin/env python3
"""Post-process PRD docx: patch footer PAGE fields with format switches (WPS compat)
and strip empty pgNumType from the cover section. Per docx skill toc.md."""
import re, shutil, sys, zipfile

PATH = "/home/z/my-project/download/FiberPro-Phase6-PRD.docx"
TMP = PATH + ".tmp"
