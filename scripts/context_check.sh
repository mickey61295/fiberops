...
check "m54 PROMPT_VERSION (M-05 expense heads: THE HEAD REFINES NEVER BLOCKS — the ExpenseHead master sets category + the default GL leg; budget-vs-actual gains the expense addend)" "1" "$(grep -c "PROMPT_VERSION = 'm54-2026-09-07'" src/lib/agent/prompt.ts)"
