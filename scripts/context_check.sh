...
check "m49 PROMPT_VERSION (L-04 attendance depth: cross-midnight + OT on the M48 line)" "1" "$(grep -c "PROMPT_VERSION = 'm49-2026-09-06'" src/lib/agent/prompt.ts)"
