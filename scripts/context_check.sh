...
check "m52 PROMPT_VERSION (M-03 final-accounts reports: TB/day-book/cash-book/P&L+BS on the GL doctrine)" "1" "$(grep -c "PROMPT_VERSION = 'm52-2026-09-06'" src/lib/agent/prompt.ts)"
