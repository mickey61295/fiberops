...
check "m51 PROMPT_VERSION (M-02 true double-entry posts: mode-aware bank legs + DN/expense GL legs)" "1" "$(grep -c "PROMPT_VERSION = 'm51-2026-09-06'" src/lib/agent/prompt.ts)"
