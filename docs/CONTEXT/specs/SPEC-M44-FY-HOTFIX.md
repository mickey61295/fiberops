# SPEC-M44 (side_quest) — Hotfix: Fiscal-Year Single Source (FY-01)

> NUMBERING NOTE (2026-09-06 merge): the side_quest branch numbered this
> hotfix SPEC-M44 from the m43 tip while origin/main had meanwhile shipped
> its own SPEC-M44 (Module K costing). The M44 number stays with the costing
> module on main; this file keeps its original branch label for the audit
> trail. Its STATE entry is #49 in the merged tree. The M45 (wage
> reconciliation) and M46 (payroll) numbers were free on main and stand.
