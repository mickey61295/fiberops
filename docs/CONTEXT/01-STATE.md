...
26. **M21 DONE** (2026-08-30, SPEC-M21): waste receipt — stock-adj variant (WST-####, waste classes) + receive_waste tool (225) + /inventory/waste-receipt + menu (132/165). 949 vitest, tsc src/ 0, eval --static PASS, context_check 535/535, route_smoke_m21 15/15. **Next candidates (P3 lane continues)**: keypad-operator mode (M22, gap-audit §7-K) → e-invoice/e-way mock IRN (M23, Gap D #11) → voice entry (V, needs STT decision).
