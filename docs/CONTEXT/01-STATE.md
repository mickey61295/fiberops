...
| ERP view/shell components | **30** (23 + M6-C lifecycle-form + M6-D approval-queue + M8-A print trio + M9 live-tracker + M17 register-rows) | `ls src/components/erp/*.tsx \| wc -l` |
