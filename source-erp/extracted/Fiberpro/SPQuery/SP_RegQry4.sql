...
; =============================================  */  
CREATE PROCEDURE SP_RegQry4 (@Coycode int,@TmpOrdid nVarchar(max))
AS
...
(dbo.ordermas.ordid IN ((Select ID From fnSplitter(@TmpOrdid)))) AND (dbo.Trs_Del1.TrType = -1) AND Trs_Del1.DELTYPE = ''R'' AND (dbo.StockTable.Coycode = @Coycode) 
