...
; Last Change Date :  18/09/2024 10.10 AM 
	...
	SELECT @DelType = '' from Trs_LineInput as Trs_Pcs1 Where id =@Id     
		...
		if @DelType ='Sales' 	
			...
			BEGIN	  
				...
				END /*Select Top 1 @FinishedStageID = StageId  From Pcs_StockTable A INNER JOIN Mas_JobWrkComp B ON A.StageId = B.I
