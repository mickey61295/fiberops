...
Public Class Rpt_FabWiseOrdReqReg1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_FabWiseOrdReqReg1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_FabWiseOrdReqReg1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_FabWiseOrdReqReg1 = New Rpt_FabWiseOrdReqReg1
        rpt.Site = Me.Site
        Return rpt
    End Function
