...
namespace Reports
{
    ...
    public class Report : Stimulsoft.Report.StiReport
    {
        ...
        public YarnGRNDataSource YarnGRN;
        
        public void Text1__GetValue(object sender, Stimulsoft.Report.Events.StiGetValueEventArgs e)
        {
            e.Value = ToString(sender, YarnGRN.Heading, true) + " - " + ToString(sender, YarnGRN.Deptname, true);
        }
        ...
        {
            e.Value = ToString(sender, YarnGRN.ExpCST, true);
        }
        
        public void Text12__GetValue(object sender, Stimulsoft.Report.Events.StiGetValueEventArgs e)
        {
            e.Value = ToString(sender, YarnGRN.Pname, true);
        }
        ...
        {
            e.Value = ToString(sender, YarnGRN.Paddress, true);
        }
        ...
        {
            e.Value = ToString(sender, YarnGRN.GrnNo, true);
        }
        ...
        {
            e.Value = this.Text24.TextFormat.Format(CheckExcelValue(sender, YarnGRN.dt));
        }
        ...
        {
            e.Value = ToString(sender, YarnGRN.OrderNo, true);
        }
        ...
        {
            e.Value = ToString(sender, YarnGRN.remark, true);
        }
        ...
        {
            e.Value = "For " + ToString(sender, YarnGRN.ExporterName, true);
        }
        ...
        {
            this.Text64_Sum.CalcItem(YarnGRN.RecKgs);
            this.Text67_Sum.CalcItem(YarnGRN.RBag);
        }
        
        private void InitializeComponent()
        {
            this.YarnGRN = new YarnGRNDataSource();
            ...
            // ReportChanged
            // 
            this.ReportChanged = new DateTime(2009, 8, 1, 16, 13, 4, 906);
            // 
            // ReportCreated
            // 
            this.ReportCreated = new DateTime(2009, 7, 30, 17, 28, 18, 0);
            this.ReportGuid = "ac121f23164941ba840da3d75870c93e";
            ...
            this.Data1.DataSourceName = "YarnGRN";
            ...
            this.Text34.ClientRectangle = new Stimulsoft.Base.Drawing.RectangleD(0.5, 0, 2, 0.2);
            ...
            this.Text35.ClientRectangle = new Stimulsoft.Base.Drawing.RectangleD(2.6, 0, 1.3, 0.2);
            ...
            this.Text36.ClientRectangle = new Stimulsoft.Base.Drawing.RectangleD(3.9, 0, 1.9, 0.2);
        ...
        public void InitializeComponent2()
        {
            ...
            this.Pages.AddRange(new Stimulsoft.Report.Components.StiPage[] {
                        this.Page1});
            this.YarnGRN.Columns.AddRange(new Stimulsoft.Report.Dictionary.StiDataColumn[] {
            ...
            this.YarnGRN.Parameters.AddRange(new Stimulsoft.Report.Dictionary.StiDataParameter[] {
                        new Stimulsoft.Report.Dictionary.StiDataParameter("@Id", 8, 0)});
            this.DataSources.Add(this.YarnGRN);
            ...
            this.YarnGRN.Connecting += new System.EventHandler(this.GetYarnGRN_SqlCommand);
        }
        
        public void GetYarnGRN_SqlCommand(object sender, System.EventArgs e)
        {
            this.YarnGRN.SqlCommand = "SELECT     RTRIM(CAST(Trs_Grn1.DocNo AS varchar)) + \'/\' + Trs_Grn1.Finyear AS Grn" +
...
"          RefNo = CASE WHEN trs_grn1.POId > 0 THEN RTRIM(CAST(Trs_Po1.DocNo AS v" +
"archar)) \r\n                      + \'/\' + Trs_Po1.Finyear ELSE rtrim(cast(Trs_Del" +
"1.DocNo AS varchar)) + \'/\' + Trs_Del1.Finyear END, Mas_Party.Pname, Mas_Party.Pa" +
"ddress, \r\n                      Mas_Party.Phone, Mas_Party.TIN, Mas_Party.CST, M" +
"as_Exporter.ExporterName, Mas_Exporter.ExporterAddress, Mas_Exporter.Phone AS Ex" +
"pPhone, \r\n                      Mas_Exporter.TIN AS ExpTIN, Mas_Exporter.CST AS " +
"ExpCST, Mas_Dept.Deptname, Mas_Grp.GRNPre, Mas_Mill.Mill, Mas_Count.CountName, \r" +
"\n                      Mas_Color.ColorDesc\r\n\t\t\t\t\t  ,Heading=Case Grntype when \'P" +
"urchase\' then \'GOODS RECEIVED NOTE\' when \'Process\' then \'PROCESS RECEIPT\' when \'" +
"Process Return\' then \'PROCESS RETURN\' end \r\nFROM         dbo.Trs_Grn1 Trs_Grn1 I" +
"NNER JOIN\r\n                      dbo.OrderMas OrderMas ON Trs_Grn1.OrdID = Order" +
"Mas.OrdId INNER JOIN\r\n                      dbo.Trs_GRN2 Trs_GRN2 ON Trs_Grn1.ID" +
" = Trs_GRN2.ID INNER JOIN\r\n                      dbo.Mas_Party Mas_Party ON Trs_" +
"Grn1.SuppID = Mas_Party.PID LEFT OUTER JOIN\r\n                      dbo.Mas_Expor" +
"ter Mas_Exporter ON Trs_Grn1.Coycode = Mas_Exporter.ExpID LEFT OUTER JOIN\r\n     " +
"                 dbo.Mas_Dept Mas_Dept ON Trs_Grn1.Dept = Mas_Dept.DeptID LEFT O" +
"UTER JOIN\r\n                      dbo.Trs_Del1 Trs_Del1 ON Trs_Grn1.DCID = Trs_De" +
"l1.ID LEFT OUTER JOIN\r\n                      dbo.Trs_Po1 Trs_Po1 ON Trs_Grn1.PoI" +
"D = Trs_Po1.ID INNER JOIN\r\n                      dbo.StockTable StockTable ON Tr" +
"s_GRN2.StockID = StockTable.StockID LEFT OUTER JOIN\r\n                      dbo.M" +
"as_Grp Mas_Grp ON Mas_Dept.Grp = Mas_Grp.GrpNo INNER JOIN\r\n                     " +
" dbo.Mas_Count Mas_Count ON StockTable.CntID = Mas_Count.CountID INNER JOIN\r\n   " +
"                   dbo.Mas_Mill Mas_Mill ON StockTable.MillID = Mas_Mill.MillID " +
"LEFT OUTER JOIN\r\n                      dbo.Mas_Color Mas_Color ON StockTable.Col" +
"ID = Mas_Color.ColID\r\nwhere Trs_Grn1.id=?";
            this.YarnGRN.Parameters["@Id"].ParameterValue = 0;
        }
        
        #region DataSource YarnGRN
        public class YarnGRNDataSource : Stimulsoft.Report.Dictionary.StiOdbcSource
        {
            
            public YarnGRNDataSource() : 
                    base("Connection", "YarnGRN", "YarnGRN", "", true, false, 30)
            {
            }
