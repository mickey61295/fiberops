...
Public Class Rpt_FabWiseOrdReqReg
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_FabWiseOrdReqReg.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_FabWiseOrdReqReg
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_FabWiseOrdReqReg = New Rpt_FabWiseOrdReqReg
        rpt.Site = Me.Site
        Return rpt
    End Function
