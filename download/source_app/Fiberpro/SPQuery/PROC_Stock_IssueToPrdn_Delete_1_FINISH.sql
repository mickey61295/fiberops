...
select @EmpID = IsNull(EmpID,0) from Trs_LineInput as trs_pcs1 where id=@id      
...
Select Distinct Trs_Pcs2.Id,StyleNo,Trs_Pcs2.Colid,Trs_Pcs2.PartId,SizeId,IsNull(lotNo,'') LotNo,Pcs,c.SourceStageId FROM Trs_LineInput_Det as Trs_Pcs2 
INNER JOIN Trs_IsstoProd_SourceStageDtl C ON Trs_PCs2.ID = C.ID 
Where trs_Pcs2.ID=@Id And StyleNo=@StyleNo and Trs_Pcs2.Colid = @ColId and Trs_Pcs2.PartId = @PartId And SizeId =@SizeId and LotNo  =
 @LotNo  
OPEN LINE_CURSOR   
