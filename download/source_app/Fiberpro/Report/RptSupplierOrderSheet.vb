...
Public Class RptSupplierOrderSheet
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptSupplierOrderSheet.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_RptSupplierAcc_Pm_SuppOrdMasSuppOrdId() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptSupplierOrderSheet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptSupplierOrderSheet = New RptSupplierOrderSheet
        rpt.Site = Me.Site
        Return rpt
    End Function
