...
namespace Reports
{
    ...
    public class Report : Stimulsoft.Report.StiReport
    {
        ...
        public AccGRNDataSource AccGRN;
        
        public void Text1__GetValue(object sender, Stimulsoft.Report.Events.StiGetValueEventArgs e)
        {
            e.Value = ToString(sender, AccGRN.Heading, true) + " - ACCESSORIES";
        }
        ...
        {
            e.Value = ToString(sender, AccGRN.ExpCST, true);
        }
        
        public void Text12__GetValue(object sender, Stimulsoft.Report.Events.StiGetValueEventArgs e)
        {
            e.Value = ToString(sender, AccGRN.Pname, true);
        }
        ...
        {
            e.Value = ToString(sender, AccGRN.Padd, true);
        }
        ...
        {
            e.Value = ToString(sender, AccGRN.GRNNo, true);
        }
        ...
        {
            e.Value = this.Text24.TextFormat.Format(CheckExcelValue(sender, AccGRN.dt));
        }
        ...
        {
            e.Value = ToString(sender, AccGRN.OrderNo, true);
        }
        ...
        {
            e.Value = ToString(sender, AccGRN.remark, true);
        }
        ...
        private void InitializeComponent()
        {
            ...
            // ReportChanged
            // 
            this.ReportChanged = new DateTime(2009, 8, 1, 17, 25, 30, 234);
            // 
            // ReportCreated
            // 
            this.ReportCreated = new DateTime(2009, 7, 30, 17, 28, 18, 0);
            this.ReportGuid = "fd9ffb5795914293b76ba8bbbbca3059";
            ...
            this.Data1.DataSourceName = "AccGRN";
        ...
        public void InitializeComponent2()
        {
            ...
            this.Pages.AddRange(new Stimulsoft.Report.Components.StiPage[] {
                        this.Page1});
            this.AccGRN.Columns.AddRange(new Stimulsoft.Report.Dictionary.StiDataColumn[] {
                        ...
                        new Stimulsoft.Report.Dictionary.StiDataColumn("Buyer", "Buyer", "Buyer", typeof(int)),
                        ...
                        new Stimulsoft.Report.Dictionary.StiDataColumn("Padd", "Padd", "Padd", typeof(string)),
                        new Stimulsoft.Report.Dictionary.StiDataColumn("PPhone", "PPhone", "PPhone", typeof(string)),
                        new Stimulsoft.Report.Dictionary.StiDataColumn("LblTIN", "LblTIN", "LblTIN", typeof(string)),
                        new Stimulsoft.Report.Dictionary.StiDataColumn("LblCST", "LblCST", "LblCST", typeof(string)),
            ...
            this.AccGRN.Parameters.AddRange(new Stimulsoft.Report.Dictionary.StiDataParameter[] {
                        new Stimulsoft.Report.Dictionary.StiDataParameter("@Id", 8, 0)});
            this.DataSources.Add(this.AccGRN);
            ...
            this.AccGRN.Connecting += new System.EventHandler(this.GetAccGRN_SqlCommand);
        }
        
        public void GetAccGRN_SqlCommand(object sender, System.EventArgs e)
        {
            this.AccGRN.SqlCommand = "SELECT      RTRIM(CAST(Trs_Grn1.DocNo AS varchar)) + \'/\' + Trs_Grn1.Finyear AS GR" +
"NNo, Trs_Grn1.dt, Trs_Grn1.PartyDCref, \r\n                      Trs_Grn1.GRNType," +
" Trs_Grn1.remark, Trs_Grn1.grnwgt, Trs_Grn1.Buyer, Trs_GRN2.RecKgs, RTRIM(CAST(O" +
"rderMas.Jobno AS varchar)) \r\n                      + \'/\' + OrderMas.Finyear + \'-" +
">\' + OrderMas.BuyOrdNo AS OrderNo, OrderMas.StyleNo,  \r\n                      Ma" +
"s_Party.TIN, Mas_Party.CST, Mas_Exporter.ExporterName, Mas_Exporter.ExporterAddr" +
"ess, Mas_Exporter.Phone AS ExpPhone, \r\n                      Mas_Exporter.TIN AS" +
" ExpTIN, Mas_Exporter.CST AS ExpCST, Mas_Dept.Deptname,   \r\n                    " +
"  Mas_Grp.GRNPre, Mas_Color.ColorDesc, Mas_Size.SizeDesc, OrdSizeMas.SNo, Mas_Ac" +
"c.Acc_Descr, \r\n                      Mas_AccDes.AccDescription, Mas_Uom.Uom, Ref" +
"No = CASE WHEN Trs_Grn1.PoID > 0 THEN rtrim(cast(Trs_Po1.DocNo AS varchar)) \r\n  " +
"                    + \'/\' + Trs_Po1.Finyear ELSE rtrim(cast(Trs_Del1.DocNo AS va" +
"rchar)) + \'/\' + Trs_Del1.Finyear END,\r\n\t\t      Pname =case when isnull(Trs_Grn1." +
"buyer,0)>0 then Mas_Buyer.BuyerName else Mas_Party.Pname end,\r\n                 " +
"     Padd =case when isnull(Trs_Grn1.buyer,0)>0 then Mas_Buyer.BuyerAddress else" +
" Mas_Party.Paddress end,\t\t\t\t \t\r\n\t\t      PPhone= case when isnull(Trs_Grn1.buyer," +
"0)>0 then Mas_Buyer.Phone else Mas_Party.Phone end,\t\t\t\t \t\t\r\n\t\t      LblTIN = cas" +
"e when isnull(Trs_Grn1.buyer,0)>0 then \'\' else \'TIN\' end,\t\t\t\t \t\t\r\n\t\t      LblCST" +
" = case when isnull(Trs_Grn1.buyer,0)>0 then \'\' else \'CST\' end,\r\n\t\t      Heading" +
"=case grntype when \'Acc.Purch\' then \'GOODS RECEIVED NOTE\' when \'Acc.Direct\' then" +
" \'DIRECT GOODS RECEIVED NOTE\' when \'Acc.Iss.Ret\' then \'ISSUE RETURN\'\r\n\t\t      wh" +
"en \'Acc.Proc.Receipt\' then \'PROCESS RECEIPT\' when \'Acc.Proc.Return\' then \'PROCES" +
"S RETURN\' end,\r\n              ItemDesc =case When isnull(Mas_AccDes.AccDescripti" +
"on,\'\')=\'\' then Mas_Acc.Acc_Descr else Mas_Acc.Acc_Descr +\'(\' + Mas_AccDes.AccDes" +
"cription +\')\' end \r\nFROM         dbo.Trs_Grn1 Trs_Grn1 INNER JOIN\r\n             " +
"         dbo.OrderMas OrderMas ON Trs_Grn1.OrdID = OrderMas.OrdId INNER JOIN\r\n  " +
"                    dbo.Trs_GRN2 Trs_GRN2 ON Trs_Grn1.ID = Trs_GRN2.ID INNER JOI" +
"N\r\n                      dbo.Mas_Exporter Mas_Exporter ON Trs_Grn1.Coycode = Mas" +
"_Exporter.ExpID INNER JOIN\r\n                      dbo.Mas_Dept Mas_Dept ON Trs_G" +
"rn1.Dept = Mas_Dept.DeptID LEFT OUTER JOIN\r\n                      dbo.Trs_Del1 T" +
"rs_Del1 ON Trs_Grn1.DCID = Trs_Del1.ID LEFT OUTER JOIN\r\n                      db" +
"o.Trs_Po1 Trs_Po1 ON Trs_Grn1.PoID = Trs_Po1.ID LEFT OUTER JOIN\r\n               " +
"       dbo.Mas_Buyer Mas_Buyer ON Trs_Grn1.Buyer = Mas_Buyer.BuyerID LEFT OUTER " +
"JOIN\r\n                      dbo.Mas_Party Mas_Party ON Trs_Grn1.SuppID = Mas_Par" +
"ty.PID INNER JOIN\r\n                      dbo.StockTable StockTable ON Trs_GRN2.S" +
"tockID = StockTable.StockID LEFT OUTER JOIN\r\n                      dbo.Mas_Grp M" +
"as_Grp ON Mas_Dept.Grp = Mas_Grp.GrpNo LEFT OUTER JOIN\r\n                      db" +
"o.Mas_Size Mas_Size ON StockTable.Siz = Mas_Size.SizeID LEFT OUTER JOIN\r\n       " +
"               dbo.OrdSizeMas OrdSizeMas ON StockTable.OrdID = OrdSizeMas.OrdID " +
"AND StockTable.Siz = OrdSizeMas.SizeID LEFT OUTER JOIN\r\n                      db" +
"o.Mas_Acc Mas_Acc ON StockTable.Atype = Mas_Acc.ID LEFT OUTER JOIN\r\n            " +
"          dbo.Mas_AccDes Mas_AccDes ON StockTable.Ades = Mas_AccDes.ID LEFT OUTE" +
"R JOIN\r\n                      dbo.Mas_Color Mas_Color ON StockTable.ColID = Mas_" +
"Color.ColID LEFT OUTER JOIN\r\n                      dbo.Mas_Uom Mas_Uom ON Mas_Ac" +
"c.UomId = Mas_Uom.UomID\r\nwhere Trs_Grn1.id=?\r\nORDER BY Mas_Acc.Acc_Descr";
            this.AccGRN.Parameters["@Id"].ParameterValue = 0;
        }
        
        #region DataSource AccGRN
        public class AccGRNDataSource : Stimulsoft.Report.Dictionary.StiOdbcSource
        {
            
            public AccGRNDataSource() : 
                    base("Connection", "AccGRN", "AccGRN", "", true, false, 30)
            {
            }
            ...
            public virtual int Buyer
            {
                get
                {
                    return ((int)(StiReport.ChangeType(this["Buyer"], typeof(int), true)));
                }
            }
            ...
            public virtual string Padd
            {
                get
                {
                    return ((string)(StiReport.ChangeType(this["Padd"], typeof(string), true)));
                }
            }
            
            public virtual string PPhone
            {
                get
                {
                    return ((string)(StiReport.ChangeType(this["PPhone"], typeof(string), true)));
                }
            }
            
            public virtual string LblTIN
            {
                get
                {
                    return ((string)(StiReport.ChangeType(this["LblTIN"], typeof(string), true)));
                }
            }
            
            public virtual string LblCST
            {
                get
                {
                    return ((string)(StiReport.ChangeType(this["LblCST"], typeof(string), true)));
                }
            }
