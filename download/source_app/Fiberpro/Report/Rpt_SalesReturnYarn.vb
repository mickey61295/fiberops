...
Public Class Rpt_SalesReturnYarn
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Rpt_SalesReturnYarn.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_SalesReturnYarn
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_SalesReturnYarn = New Rpt_SalesReturnYarn
        rpt.Site = Me.Site
        Return rpt
    End Function
