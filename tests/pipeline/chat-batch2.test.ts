...
describe('CHAT-12 — chat polish sweep', () => {
  ...
  it('tool count is 246 (243 at M41 + M42 INV: create_stock_take / record_stock_counts / advance_stock_take)', () => {
    expect(allTools.length).toBe(254) // M47 L-03: +get_statutory_register // M46 L-02: +create_payroll_run +commit_payroll_run +get_payroll_runs // M45 L-01: +get_operator_statement // M43 PRG: +set_order_deliveries +correct_program_spec +propose_program_requirements
