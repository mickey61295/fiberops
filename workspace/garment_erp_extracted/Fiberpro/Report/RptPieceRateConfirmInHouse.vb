...
Public Class RptPieceRateConfirmInHouse
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RptPieceRateConfirmInHouse.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TotAmt() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRptPieceRateConfirmInHouse
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptPieceRateConfirmInHouse = New RptPieceRateConfirmInHouse
        rpt.Site = Me.Site
        Return rpt
    End Function
