...
Select Id,StyleNo,Colid,PartId,SizeId,IsNull(lotNo,'') LotNo,Pcs,SourceStageId FROM Trs_LineInput_Det as Trs_Pcs2 Where ID=@Id And StyleNo=@StyleNo and Colid = @ColId and PartId = @PartId And SizeId =@SizeId and SourceStageId = @SourceStageID and LotNo  =
 @LotNo  
OPEN LINE_CURSOR   
