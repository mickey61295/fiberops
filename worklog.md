...
- Owner-side standing: §17-1's one value (ops.backup.rsync_target — local-only backups stand, the mechanism was demonstrated live), §17-7 gated on Module G. PAT rotation dismissed by the owner this session.
