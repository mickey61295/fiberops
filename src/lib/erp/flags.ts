...
export const FLAG_DEFS: FlagDef[] = [
  ...
  // — SPEC-M43 PRG-02 — multi-style orders, flag-gated; ADR-023 (2026-09-12)
  // resolves remediation spec §17-5: single-style is the DECIDED default
  // (one-flag reversible). OFF = a line style differing from the order style
  // REFUSES with the flag named; ON = per-line styles resolve and store.
  // Blank line style = header fallback in BOTH states.
