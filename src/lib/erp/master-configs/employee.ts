...
export const employeeConfig: MasterConfig = {
  ...
  fields: [
    ...
    { name: 'uan', label: 'UAN', type: 'text', description: 'Universal Account Number (PF) — stored as given, PRINTED MASKED on the payslip; presence enrols the employee for PF legs (M47 L-03)' },
    ...
    { name: 'esiNo', label: 'ESI no', type: 'text', description: 'ESI IP number — shown on the statutory register + challan export (M47 L-03)' },
