...
export const userConfig: MasterConfig = {
  ...
  fields: [
    ...
    ], defaultValue: 'admin', description: 'Functional role (menu filtering reads the GROUP rights; role is informational until auth lands)' },
    ...
    { name: 'active', label: 'Active', type: 'checkbox', defaultValue: true, description: 'Inactive users cannot log in (when auth lands)' },
  ],
