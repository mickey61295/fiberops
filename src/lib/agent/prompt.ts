...
export const PROMPT_VERSION = 'm54-2026-09-07' // M54 M-05 expense heads (THE HEAD REFINES, NEVER BLOCKS — the ExpenseHead master sets category + the default GL leg; budget-vs-actual gains the expense addend) on the M53 line
