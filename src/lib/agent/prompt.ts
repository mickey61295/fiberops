...
export const PROMPT_VERSION = 'm55-2026-09-08' // M55 L-06 shift wages (post_shift_wages — shift-level wage cost beyond piece rate, the budget-vs-actual addend; shiftCode attribution on production entries; get_shift_wages — the shift × day wage bill) on the M54 line
